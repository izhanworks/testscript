...
# Tambahan
cd /usr/bin
wget -O add-wg "https://raw.githubusercontent.com/izhanworks/testscript/main/add-wg.sh"
wget -O del-wg "https://raw.githubusercontent.com/izhanworks/testscript/main/del-wg.sh"
wget -O cek-wg "https://raw.githubusercontent.com/izhanworks/testscript/main/cek-wg.sh"
wget -O renew-wg "https://raw.githubusercontent.com/izhanworks/testscript/main/renew-wg.sh"
chmod +x add-wg
chmod +x del-wg
chmod +x cek-wg
chmod +x renew-wg
